			...
			<div class="row">
				<div class="col-lg-9 col-lg-push-3">
					...
					<div class="row">
						<div class="well clearfix">
							<div class="col-lg-3 col-md-2 text-center">
								<img src="/KinoBaza_PHP/assets/img/inter.png" alt="Интестеллар" class="img-thumbnail">
								<p>Интестеллар</p>
							</div>
							...
							<div class="col-lg-12 col-md-12">
								<a href="/KinoBaza_PHP/views/Inter.php" class="btn btn-lg btn-warning pull-right">подробнее</a>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="well clearfix">
							<div class="col-lg-3 col-md-2 text-center">
								<img src="/KinoBaza_PHP/assets/img/matrix.png" alt="матрица" class="img-thumbnail">
								<p>Матрица</p>
							</div>
							...
							<div class="col-lg-12 col-md-12">
								<a href="/KinoBaza_PHP/views/matrix.php" class="btn btn-lg btn-warning pull-right">подробнее</a>
					...
					<div class="row">
						<div class="well clearfix">
							<div class="col-lg-3 col-md-2 text-center">
								<img src="/KinoBaza_PHP/assets/img/cloud.png" alt="облачный атлас" class="img-thumbnail">
								<p>облачный атлас</p>
							</div>
							...
							<div class="col-lg-12 col-md-12">
								<a href="/KinoBaza_PHP/views/atlas.php" class="btn btn-lg btn-warning pull-right">подробнее</a>
					...
					<div class="row">
						<div class="well clearfix">
							<div class="col-lg-3 col-md-2 text-center">
								<img src="/KinoBaza_PHP/assets/img/max.png" alt="безумный макс" class="img-thumbnail">
								<p>безумный макс</p>
							</div>
							...
							<div class="col-lg-12 col-md-12">
								<a href="/KinoBaza_PHP/views/max.php" class="btn btn-lg btn-warning pull-right">подробнее</a>

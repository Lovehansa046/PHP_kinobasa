						...
						<tbody>
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/inter.png" alt="Интестеллар" class="img-responsive img-thumbnail">
								</td>
							...
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/cloud.png" alt="Облачный атлас" class="img-responsive img-thumbnail">
								</td>
							...
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/matrix.png" alt="Матрица" class="img-responsive img-thumbnail">
								</td>
							...
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/max.png" alt="Безумный макс" class="img-responsive img-thumbnail">
								</td>

						...
						<tbody>
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/breakingbad.png" alt="во все тяжкие" class="img-responsive img-thumbnail">
								</td>
							...
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/xfiles.png" alt="секретные материалы" class="img-responsive img-thumbnail">
								</td>
							...
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/silicon.png" alt="силиконовая долина" class="img-responsive img-thumbnail">
								</td>
							...
							<tr>
								<td class="col-lg-1 col-md-1 col-xs-2">
									<img src="/KinoBaza_PHP/assets/img/dead.png" alt="ходячие мертвецы" class="img-responsive img-thumbnail">
								</td>
